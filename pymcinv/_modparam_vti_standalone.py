...
class vtimod(object):
    ...
    *********************************************************************************************************************
    ...
    def __init__(self):
        ...
        self.maxlay         = 100
        self.maxspl         = 20
        self.maxlaygamma    = 10 # maximum number of layer for gamma
        self.ngamma         = 0 # number of gamma parameters
    ...
    def parameterize_ak135(self, crtthk, sedthk, crt_depth = -1., mantle_depth = -1.,\
                           vti_numbp= [0, 1, 1], vti_modtype = [-1, 0, 0], topovalue=1., maxdepth=200., vp_water=1.5):
        """
    ...
    def get_paraind(self, perturb_thk=False, std_paraval=np.array([]), issedani=True):
        """
        get parameter index arrays for para
        =============================================================================================================================
        ::: input :::
        ...
        numbp_sum_vti   = self.numbp_vti.sum()
        npara           = numbp_sum  + self.nmod + numbp_sum_vti - 1
        # water layer
        if self.mtype[0] == 5:
            npara       -= 2
        self.para.init_arr(npara)
