...
class vtih5(inviso.isoh5):
    ...
    def mc_inv_sta_vti(self, use_ref=False, instafname = None, phase = True, group=False, outdir = None, restart = False,
        crtstd = None, wdisp = 0.2, rffactor = 40., vp_water=1.5, isconstrt=True, crt_depth = -1., mantle_depth = -1.,
        step4uwalk=1500, numbrun=15000, subsize=1000, nprocess=None, parallel=True, Ntotalruns=10, misfit_thresh=1.0, Nmodelthresh=200,
        outstaid=None, verbose = False, verbose2 = False):
        """
