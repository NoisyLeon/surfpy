...
def eikonal_multithread(in_grder, workingdir, channel, tdiff, nearneighbor, cdist, cdist2, nquant, cycle_thresh, cycle_period ):
    ...
    if not in_grder.check_curvature():
        return
    in_grder.eikonal( tdiff = tdiff, nearneighbor = nearneighbor, cdist = cdist, cdist2 = cdist2, nquant = nquant)
